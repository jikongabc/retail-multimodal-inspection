...
def make_image(path: Path, kind: str, seed: int) -> None:
    ...
    # 绘制带商品和价签的货架。
    def shelf_rows(
        x0: int, y0: int, shelf_w: int, rows: int, scale: float = 1.0
    ) -> None:
        draw.rectangle(
            (x0 - 14, y0 - 22, x0 + shelf_w + 14, height - 35),
            fill=(82, 70, 59),
            outline=(42, 37, 34),
            width=3,
        )
        ...
        for row in range(rows):
            ...
            for col in range(count):
                ...
                if (row + col + seed) % 4 == 0:
                    ...
                    draw.line(
                        (px + 4, py + ph // 3, px + pw - 4, py + ph // 3),
                        fill=(245, 235, 209),
                        width=2,
                    )
            draw.rectangle(
                (x0, y + row_h - 18, x0 + shelf_w, y + row_h - 7), fill=(57, 51, 46)
            )
            if row % 2 == 0:
                draw.text(
                    (x0 + 8, y + row_h - 17),
                    f"{rng.randint(9, 39)}.{rng.randint(0, 9)}",
                    fill=(245, 235, 205),
                )
    ...
    if kind == "shelf":
        ...
        if variant == 0:
            ...
            draw.polygon(
                [(410, 70), (622, 112), (622, 370), (430, 370)],
                fill=(189, 168, 139),
                outline=(105, 87, 72),
            )
            ...
            for col in range(9):
                x = 55 + col * 54
                draw.rectangle(
                    (x, 70 + col * 2, x + 33, 116 + col * 2),
                    fill=((170 + col * 7) % 240, 80 + col * 8, 56),
                    outline=(54, 43, 35),
                    width=2,
                )
        else:
            ...
            draw.rectangle(
                (24, 314, 616, 398), fill=(111, 91, 75), outline=(64, 53, 44), width=3
            )
        ...
        if variant == 0:
            draw.rectangle(
                (60, 48, 310, 265), fill=(202, 225, 232), outline=(46, 76, 87), width=8
            )
            draw.line((185, 52, 185, 263), fill=(70, 105, 115), width=5)
            draw.line((63, 155, 307, 155), fill=(70, 105, 115), width=5)
            draw.rectangle(
                (355, 177, 548, 291), fill=(153, 89, 57), outline=(70, 47, 37), width=4
            )
            draw.ellipse(
                (389, 102, 506, 220), fill=(47, 121, 70), outline=(32, 76, 48), width=5
            )
            draw.ellipse(
                (430, 64, 556, 187), fill=(60, 142, 81), outline=(32, 76, 48), width=5
            )
            draw.line((447, 185, 444, 286), fill=(80, 53, 39), width=8)
        elif variant == 1:
            draw.polygon(
                [(30, 276), (190, 93), (385, 94), (602, 276)],
                fill=(88, 105, 119),
                outline=(49, 62, 70),
            )
            draw.polygon(
                [(62, 268), (204, 122), (356, 122), (554, 268)], fill=(169, 181, 185)
            )
            draw.rectangle(
                (248, 170, 391, 279), fill=(56, 100, 133), outline=(24, 49, 66), width=5
            )
            draw.ellipse(
                (269, 190, 369, 266), fill=(210, 180, 73), outline=(66, 59, 38), width=4
            )
            draw.line((0, 320, width, 320), fill=(210, 218, 216), width=4)
        elif variant == 2:
            draw.ellipse(
                (95, 100, 410, 330), fill=(225, 181, 64), outline=(90, 67, 33), width=7
            )
            draw.ellipse(
                (145, 145, 360, 305),
                fill=(247, 222, 115),
            ...
            draw.rectangle(
                (425, 135, 544, 290), fill=(198, 117, 54), outline=(79, 48, 30), width=5
            )
            draw.line((485, 142, 485, 283), fill=(245, 203, 117), width=4)
            draw.ellipse(
                (35, 325, 602, 435), fill=(103, 92, 92), outline=(69, 61, 63), width=3
            )
        else:
            draw.polygon(
                [(64, 280), (142, 105), (492, 105), (575, 280)],
                fill=(202, 206, 199),
                outline=(87, 94, 91),
                width=5,
            )
            draw.rectangle(
                (190, 152, 445, 281), fill=(68, 130, 163), outline=(39, 68, 83), width=5
            )
            draw.ellipse(
                (235, 177, 397, 288), fill=(184, 101, 64), outline=(83, 51, 39), width=5
            )
            draw.ellipse(
                (284, 119, 375, 205), fill=(52, 102, 64), outline=(31, 65, 41), width=4
            )
        ...
        if variant in (0, 1):
            ...
            draw.line(
                (left + 25, top + 50, right - 30, top + 50), fill=(93, 84, 103), width=4
            )
            ...
            draw.line(
                (split, top + 70, split, bottom - 30), fill=(171, 165, 174), width=2
            )
            for bar in range(5):
                x = left + 35 + bar * 48
                h = 30 + ((seed * 17 + bar * 23) % 90)
                draw.rectangle(
                    (x, bottom - 37 - h, x + 25, bottom - 37),
                    fill=((83, 120, 157), (178, 104, 76), (91, 143, 112))[bar % 3],
                )
        elif variant == 2:
            draw.polygon(
                [(92, 51), (526, 35), (572, 331), (123, 354)],
                fill=(247, 245, 237),
                outline=(91, 82, 100),
            )
            for row in range(7):
            ...
            draw.ellipse(
                (390, 106, 510, 226), fill=(113, 87, 157), outline=(65, 48, 92), width=4
            )
        ...
        draw.rectangle(
            (52, 45, 307, 307), fill=(104, 121, 126), outline=(58, 64, 66), width=7
        )
        draw.rectangle(
            (92, 78, 267, 306), fill=(48, 108, 91), outline=(31, 58, 50), width=6
        )
        draw.rectangle(
            (112, 130, 244, 161), fill=(238, 225, 72), outline=(69, 69, 28), width=3
        )
        draw.text((134, 138), "EXIT", fill=(35, 55, 39))
        draw.rectangle(
            (376, 155, 443, 296), fill=(192, 42, 35), outline=(79, 29, 25), width=5
        )
        draw.rectangle(
            (388, 174, 431, 220), fill=(226, 224, 202), outline=(80, 46, 37), width=3
        )
        draw.line((390, 223, 428, 223), fill=(246, 210, 120), width=5)
        draw.polygon(
            [(512, 305), (581, 305), (549, 197)],
            fill=(234, 150, 38),
            outline=(93, 54, 23),
        )
        draw.line((530, 270, 563, 270), fill=(250, 230, 150), width=10)
        draw.line(
            (0, 262, width, 190 + rng.randint(-18, 20)), fill=(223, 49, 43), width=8
        )
        draw.line(
            (0, 278, width, 206 + rng.randint(-18, 20)), fill=(247, 216, 73), width=6
        )

    elif kind == "hybrid":
        shelf_rows(34 + rng.randint(-8, 18), 62, rng.randint(330, 430), 2, 0.9)
        draw.rectangle(
            (438, 58, 602, 209), fill=(242, 239, 218), outline=(96, 80, 64), width=4
        )
        draw.polygon(
            [(520, 79), (583, 174), (456, 174)],
            fill=(224, 57, 44),
            outline=(95, 30, 27),
        )
        ...
        draw.rectangle(
            (438, 246, 604, 342), fill=(186, 181, 165), outline=(82, 78, 72), width=4
        )
        ...
        hard.append(
            {
                ...
                "split": "hard_negative",
                "construction": "adversarial_boundary_v5_independent_worker_gold_and_gate_policy_annotation_reuses_train_real_photo"
                if real_photo_mode
                else "adversarial_boundary_v4_independent_worker_gold_and_gate_policy_annotation_reuses_train_image",
            }
        )
